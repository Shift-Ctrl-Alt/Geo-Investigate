...
public class LandController {
    ...
    public Result deleteLandType(@ApiParam("土地类型的id") Integer landTypeId){
    ...
    public Result updateLandAttrValue(@RequestBody LandAttributeValue landAttributeValue){
    ...
    public Result deleteLandAttribute(@ApiParam("土地属性的id") Long landAttrId){
    ...
    public Result deleteLandAttrValue(@ApiParam("土地属性值的id") Long landAttrValueId){
